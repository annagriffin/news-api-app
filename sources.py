...
# res = requests.get('https://newsapi.org/v2/sources?language=en&country=us&apiKey=a952fcbd49a34cb08c80b12729935005')
# print(res.json())
...
# html += '<div id="category-search" class="hidden">\n'
# html += '<div class="uk-flex uk-flex-center uk-margin">\n'

for source in sources["sources"]:
  html += '<div class="item">\n'
  html += '<button class="uk-button uk-button-default uk-margin-right uk-margin-bottom" '

  html+= '(click)="getSource(\'' + source["id"] + '\')">' + source["name"] + '</button>\n'
  html += '</div>\n'
